...
contract SpaceCoin is ERC20 {
    ...
    uint256 public constant ICO_SUPPLY = 150_000; // 30000 * 5
    ...
    constructor(address _treasuryWallet) ERC20("SpaceCoin", "SPC") {
        ...
        ico = address(
            new SpaceCoinIco(msg.sender, address(this), treasuryWallet)
        );
        ...
        _mint(ico, ICO_SUPPLY * (10**uint256(decimals())));
    }
     ...
     *
     * @param from Address from tokens will be moved
